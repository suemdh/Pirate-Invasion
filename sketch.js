...
var engine, world, backgroundImg, waterSound, backgroundSound, cannonExplosion,PirateLaughSound;
...
function setup() {
  ...
  tower = new Tower(150, 500, 160, 310);
  cannon = new Cannon(180, 275, 100, 50, angle);
